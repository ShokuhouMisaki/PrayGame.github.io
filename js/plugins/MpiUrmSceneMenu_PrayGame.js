(function(){
    ...
    let SETTINGS = {
         ...
         */
        Destination:    { label: '接下来的目标', vid: 13 },
        /* お金
         *  label: お金欄に表示するラベル
         */
        Gold:           { label: '金币' },
        /* 経験値
         *  text:        経験値ゲージの上に表示するテキスト
         *  tx, ty:      テキストを表示する座標
         *  param_width: 経験値を表示する幅
         *  gx, gy:      ゲージを表示する座標
         *  color1:      ゲージ色（開始色）
         *  color2:      ゲージ色（終端色）
         *  gauge_width: ゲージの幅
        ...
        /* 立ち絵
         *  file: 立ち絵として表示する画像ファイル名のプレフィックス（※後述）
         *  x, y: 画像を表示する座標
         *  vid:  立ち絵を切り替える変数の画像
         *  max:  立ち絵の種類の数
         * 
        ...
        ActorPicture:  [{ file: 'ActorPicture_',  vid: 61, max: 8, x: 400, y: 0 },
                        ...
                        { file: 'ActorPicture7_', vid: 99, max: 1, x: 150, y: 10 },   //絶頂Ｐ
    ...
    let SETTINGS2 = {
        ...
        */
        ...
        /* 感度
         *  label:  感度のラベル
         *  file:   感度表現として表示する画像ファイル名のプレフィックス（※後述）
         *  fx, fy: 画像を表示する座標（原点中心）
         *  vid:    感度の変数の番号
         *  vx, vy: 感度を表示する座標
         *  width:  感度を表示する範囲の横幅（この幅の中で右寄せ表示）
         *  border: 画像切り替えの境界値（※後述）
         * 
         *  画像ファイル名について
        ...
        /* 状態
         *  label:  状態のラベル
         *  file:   状態表現として表示する画像ファイル名のプレフィックス（※後述）
         *  fx, fy: 画像を表示する座標（原点中心）
         *  vid:    状態の変数の番号
         *  vx, vy: 状態を表示する座標
         *  text:   状態の内容を示すテキスト（※後述）
         * 
         *  画像ファイル名について
         *   fileで指定したファイル名のプレフィックスに、変数の値を加えたものをファイル名として表示します。
         ...
         *   例えばtextが['処女', '中出し', '妊娠']で変数の値が「1」だった場合、「中出し」と表示されます。
         */
